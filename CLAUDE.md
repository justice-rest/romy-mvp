...
- `docker compose up -d` - Run the application with Docker (includes PostgreSQL 17, Redis, Rōmy app, and SearXNG)
...
- Rōmy Cloud deployments block `ENABLE_AUTH=false` automatically
