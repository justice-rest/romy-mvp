              ...
              <div className='flex flex-row items-center gap-2 mx-auto p-2'>
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-center w-full max-w-7xl mx-auto py-4 pb-40 px-4 gap-1">
                    ...
                    <p className="text-base text-gray-4 relative z-10 dark:text-gray-11 max-w-xs text-center">Rōmy is an open source answer engine powered by large language models.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className='flex flex-col divide-y divide-gray-3 lg:divide-y-0 lg:grid grid-cols-1 md:grid-cols-3 border-gray-3 dark:border-gray-21 mx-auto'>
                <div className="flex flex-col gap-1 border-gray-3 dark:border-gray-2 lg:border-r p-8">
                  <div className="flex flex-col gap-1 mb-1">
                    <h3 className="text-base font-small text-gray-12 text-pretty">Every AI model</h3>
                  </div>
                ...
                <div className="flex flex-col gap-1 border-gray-3 dark:border-gray-2 lg:border-r p-8">
                  <div className="flex flex-col gap-1 mb-1">
                    <h3 className="text-base font-small text-gray-12 text-pretty">Credit based pricing</h3>
                  </div>
                  <p className="text-xs text-gray-10 text-pretty">
                ...
                <div className="flex flex-col gap-1 border-gray-3 p-8">
                  <div className="flex flex-col gap-1 mb-1">
                    <h3 className="text-base font-small text-gray-12 text-pretty">Built For power users</h3>
                  </div>
                  <p className="text-xs text-gray-10 text-pretty">
                ...
                <div className="flex flex-col gap-1 border-gray-3 dark:border-gray-2 lg:border-t p-10 col-span-3 items-center justify-center">
                  <div className="flex flex-col gap-1 items-center mb-1 mt-2">
                    ...
                    <p className="text-xs text-gray-10 max-w-sm text-center">
                      Rōmy is fully open-source and built with modern tech like Next.js, Tailwind CSS, and Vercel's AI SDK.
                    </p>
                  </div>
                  <div className='flex flex-row gap-2 mt-2'>
                    <Button size="small" href="https://github.com/miiura/morphic" target="_blank" className="w-max mt-2 bg-gray-3 hover:bg-gray-4 text-gray-12 border border-gray-5" icon={<Code size={14} weight="bold" />}>View Code</Button>
                  </div>
                </div>
              </div>
            </div>
