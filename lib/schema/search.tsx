...
export const searchSchema = z.object({
  ...
  max_results: z
    ...
    .optional()
    .default(30)
    .describe('The maximum number of results to return. Default is 30. Minimum is 10. Maximum is 100. Use higher values (30-50) for comprehensive research requiring many sources.'),
  search_depth: z
    .string()
    .optional()
    .default('basic')
...
export const strictSearchSchema = z.object({
  ...
  max_results: z.number().min(10).max(100).describe('The maximum number of results to return. Minimum is 10. Maximum is 100. Use higher values (30-50) for comprehensive research requiring many sources.'),
  search_depth: z
    .enum(['basic', 'advanced'])
